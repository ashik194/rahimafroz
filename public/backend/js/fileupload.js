(function () {
  ...
  const SingleElementSecond = document.querySelector('.basic-filepond-second');
  const SingleElementThird = document.querySelector('.basic-filepond-third');
  const MultipleElement = document.querySelector('.multiple-filepond');
  const CircularElement = document.querySelector('.circular-filepond');
  
  /* default input */
  FilePond.create(SingleElement);
  FilePond.create(SingleElementSecond);
  FilePond.create(SingleElementThird);
