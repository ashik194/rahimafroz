    ...
    <div class="col-span-12">
        <div class="box">
            ...
            <div class="flex ">
                                                        ...
                                                        <tr class="border-b border-defaultborder">
                                                            <th scope="row">
                                                                <div class="flex items-center">
                                                                    <img src="{{asset($award->image)}}" alt="img" class="h-[200px]">
                                                                </div>
                                                            </th>
                                                            <td >{!! Str::limit($award->title, 50, '...') !!}</td>
                                                            <td>
                                                                <div class="hstack gap-2 flex-wrap">
                                                                    <a aria-label="anchor" href="{{route('admin.award.edit',$award->id)}}" class="mx-2 text-info text-[.875rem] leading-none"><i
                                                                            class="ri-edit-line"></i></a>
                                                                    <a aria-label="anchor" href="{{route('admin.award.delete',$award->id)}}" class="mx-2 text-danger text-[.875rem] leading-none"><i
                ...
                <div class="flex-1">
                    <div class="box-body">
                        <form  action="{{route('admin.award.create')}}" enctype="multipart/form-data" method="POST">
                            @csrf
                            ...
                            <div class="grid lg:grid-cols-2 gap-6">
                                ...
                                <div class="space-y-2 my-2">
                                    ...
                                    <input type="text" class="phonenumber my-auto ti-form-input  rounded-sm" name="title" placeholder="Slider title goes to here." >
                                </div>
                                <div class="space-y-2 my-2">
