...
@section('content')
    <div class="h-[300px]" style="background-size: cover; background-position: center; background-repeat: no-repeat; background-image: url('{{asset("/images/system/Management.png")}}')">
    ...
    <div class="px-[133px] bg-[#DDEBF6] py-20">
        ...
        <div class="container mx-auto w-[80%] mt-20">
            <dov class="flex justify-between ">
                <div class="w-48">
                    <div>
                        <img class="w-full" src="{{asset('/images/system/1st-img.png')}}" alt="">
                    </div>
