...
@section('content')
<div class="h-[400px]" style="background-size: cover; background-position: center; background-repeat: no-repeat; background-image: url('{{asset("/images/system/Rahimafrooz Batteries Ltd.png")}}')">
...
<div class="bg-[#DDEBF6]" style="background-size: cover; background-position: center; background-repeat: no-repeat;background-image:url({{asset('/images/system/rahim-afroz-patern-2.png')}}">
    ...
    <div class="container mx-auto pt-20 px-[133px]">
...
{{--                frameborder="0"></iframe>--}}
    ...
    <div class="container mx-auto mt-20 pb-20 px-[133px]">
        <div class="flex items-center mt-12">
            <div class="">
                <div class="h-[280px] w-[720px] bg-[#0D72B9] p-10">
                    <h1 class="text-white text-4xl mb-4">Rahimafrooz Batteries Ltd.</h1>
                    <p class="text-2xl text-justify text-white">
            ...
            <div class="">
                <img src="{{asset('images/system/Image-01.png')}}" alt="" class="w-full h-[550px]">
            </div>
        </div>
        <div class="flex items-center mt-12">
            <div class="">
                <img src="{{asset('images/system/Image-02.png')}}" alt="" class="w-full h-[550px]">
            </div>
            <div class="">
                <div class="h-[280px] w-[720px] bg-[#0D72B9] p-10">
                    <h1 class="text-white text-4xl mb-4">Rahimafrooz Globatt Ltd.</h1>
                    <p class="text-2xl text-justify text-white">
        ...
        <div class="flex items-center mt-12">
            <div class="">
                <div class="h-[280px] w-[720px] bg-[#0D72B9] p-10">
                    <h1 class="text-white text-4xl mb-4">Rahimafrooz Accumulators Ltd.</h1>
                    <p class="text-2xl text-justify text-white">
            ...
            <div class="">
                <img src="{{asset('images/system/Image-03.png')}}" alt="" class="w-full h-[550px]">
            </div>
        </div>
    </div>
    ...
    <p class=" mt-6 text-center text-2xl px-36">
...
<div class="container mx-auto mt-10 pb-20 px-[133px]">
