...
@section('content')
    <div class="h-[360px]" style="background-size: cover; background-position: center; background-repeat: no-repeat; background-image: url('{{asset("/images/system/Manufacturing-banner.png")}}')">
