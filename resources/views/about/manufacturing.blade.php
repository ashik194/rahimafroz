    ...
    <div class="px-[133px] bg-[#DDEBF6] py-20">
        <div class="container mx-auto">
            <div class="flex justify-between gap-20">
                <div class="w-1/2 bg-[#005CAB] py-10 px-20">
            ...
            <div class="flex justify-between gap-20 my-16">
                <div class=" flex-1">
                    <img class="object-cover" src="{{asset("/images/system/manufacturing.png")}}" alt="">
                </div>
            ...
            <div class="flex justify-between gap-20 my-16">
                ...
                <div class="flex-1 border-b-2 border-[#005CAB]">
                    <h2 class="text-[#0D72B9] text-xl font-bold">Die Casting </h2>
                    <h3 class="text-[#0D72B9] text-lg">Machine</h3>
                    <p class="mt-2 mb-6 text-justify">
            ...
            <div class="flex justify-between gap-20 my-16">
                <div class="flex-1 border-b-2 border-[#005CAB]">
                    <h2 class="text-[#0D72B9] text-xl font-bold">Injection </h2>
            ...
            <div class="flex justify-between gap-20 my-16">
                ...
                <div class="flex-1 border-b-2 border-[#005CAB]">
                    <h2 class="text-[#0D72B9] text-xl font-bold">Oxide Mill</h2>
            ...
            <div class="flex justify-between gap-20 my-16">
                <div class="flex-1 border-b-2 border-[#005CAB]">
                    <h2 class="text-[#0D72B9] text-xl font-bold">Quality</h2>
