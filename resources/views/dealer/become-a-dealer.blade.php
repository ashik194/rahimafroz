...
@section('content')
<div class="h-[120px] sm:h-[200px] lg:h-[300px] xl:h-[400px]" style="background-size: cover; background-position: center; background-repeat: no-repeat; background-image: url('{{asset("/images/system/dealer-banner.png")}}')">
            ...
            <div class="mt-12">
                <div class="w-full">
                    <form class="px-2 md:px-8 pt-6 pb-8 mb-4">
                        <div class="flex justify-between gap-2 md:gap-10 lg:gap-20">
