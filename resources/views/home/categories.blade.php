<div class="relative bg-[#0D72B9]"
    ...
    <div class="container mx-auto">
        <div class="container mx-autopx-[133px] h-12 bg-[#0D72B9] rounded-3xl absolute top-[-24px] z-10"></div>
        <div class="px-[133px] z-20">
            <div class="pt-16">
            ...
            <div class="py-16">
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
                    <div class="col-span-1 mt-8 text-center">
                        ...
                        <div class="m-4 bg-white h-20 w-full rounded-lg flex items-center justify-between px-4">
                            <div class="mx-2">
                                <select id="" name="category"
                                        class="block bg-[#005CAB] w-[130px] rounded-md border-0 py-1.5 text-white shadow-sm ring-1 ring-inset ring-[#DDEBF6] focus:ring-2 focus:ring-inset focus:ring-[#DDEBF6] sm:max-w-xs sm:text-sm sm:leading-6">
                            ...
                            <div class="mx-2">
                                <form action="" class="hidden md:block">
                                    <input type="search" name="" id="" class="bg-[#95E7F4] border-4 border-[#0D72B9] h-[40px] placeholder-[#0D72B9] font-bold rounded-lg w-4/4 lg:inline-block lg:ml-auto " placeholder="FIND BATTERY">
